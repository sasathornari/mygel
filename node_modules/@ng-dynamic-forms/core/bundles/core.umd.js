(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs'), require('reflect-metadata'), require('rxjs/operators'), require('@angular/core'), require('@angular/forms'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('@ng-dynamic-forms/core', ['exports', 'rxjs', 'reflect-metadata', 'rxjs/operators', '@angular/core', '@angular/forms', '@angular/common'], factory) :
    (global = global || self, factory((global.ngDynamicForms = global.ngDynamicForms || {}, global.ngDynamicForms.core = {}), global.rxjs, null, global.rxjs.operators, global.ng.core, global.ng.forms, global.ng.common));
}(this, function (exports, rxjs, reflectMetadata, operators, core, forms, common) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var DynamicFormControlModel = /** @class */ (function () {
        function DynamicFormControlModel(config, layout) {
            ...
            this.disabled$ = new rxjs.BehaviorSubject(isBoolean(config.disabled) ? config.disabled : false);
    ...
    var DynamicFormValueControlModel = /** @class */ (function (_super) {
        ...
        function DynamicFormValueControlModel(config, layout) {
            ...
            _this.value$ = new rxjs.BehaviorSubject(config.value !== null && config.value !== undefined ? config.value : null);
    ...
    var DynamicInputModel = /** @class */ (function (_super) {
        ...
        Object.defineProperty(DynamicInputModel.prototype, "hasList", {
             ...
             */
            function () {
                return rxjs.isObservable(this.list$);
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(DynamicInputModel.prototype, "list", {
            ...
            function (list) {
                ...
                if (Array.isArray(list)) {
                    this._list = list;
                    this.list$ = rxjs.of(this._list);
                }
                else if (rxjs.isObservable(list)) {
                    this.list$ = ((/** @type {?} */ (list))).pipe(operators.tap((/**
                     * @param {?} list
                     * @return {?}
                     */
    ...
    var DynamicListDirective = /** @class */ (function () {
        ...
        DynamicListDirective.propDecorators = {
            listId: [{ type: core.Input, args: ["dynamicList",] }]
        };
    ...
    var DynamicTemplateDirective = /** @class */ (function () {
        ...
        DynamicTemplateDirective.propDecorators = {
            ...
            modelId: [{ type: core.Input }],
            modelType: [{ type: core.Input }]
        };
    ...
    var DynamicOptionControlModel = /** @class */ (function (_super) {
         ...
         */
        function () {
            this.options$ = rxjs.of(this.options);
        };
        Object.defineProperty(DynamicOptionControlModel.prototype, "options", {
            ...
            function (options) {
                ...
                else if (rxjs.isObservable(options)) {
                    this.options$ = ((/** @type {?} */ (options))).pipe(operators.map((/**
                     * @param {?} optionsConfig
                     * @return {?}
                     */
    ...
    var DynamicSelectModel = /** @class */ (function (_super) {
        ...
        function DynamicSelectModel(config, layout) {
            ...
            _this.compareWithFn = isFunction(config.compareWithFn) ? config.compareWithFn : core.ɵlooseIdentical;
     ...
     */
    /** @type {?} */
    var DYNAMIC_VALIDATORS = new core.InjectionToken("DYNAMIC_VALIDATORS");
    ...
    var DynamicFormValidationService = /** @class */ (function () {
        ...
        function (validatorName, validatorArgs, validatorsToken) {
            ...
            /** @type {?} */
            var validatorFn;
            if (forms.Validators.hasOwnProperty(validatorName)) { // Built-in Angular Validators
                validatorFn = ((/** @type {?} */ (forms.Validators)))[validatorName];
            }
        ...
        DynamicFormValidationService.ctorParameters = function () { return [
            ...
            { type: Map, decorators: [{ type: core.Optional }, { type: core.Inject, args: [DYNAMIC_VALIDATORS,] }] }
        ]; };
        /** @nocollapse */ DynamicFormValidationService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function DynamicFormValidationService_Factory() { return new DynamicFormValidationService(core.ɵɵinject(forms.NG_VALIDATORS, 8), core.ɵɵinject(forms.NG_ASYNC_VALIDATORS, 8), core.ɵɵinject(DYNAMIC_VALIDATORS, 8)); }, token: DynamicFormValidationService, providedIn: "root" });
    ...
    var DynamicFormService = /** @class */ (function () {
        ...
        function (formArrayModel) {
            ...
            return new forms.FormArray(controls, options);
        };
        /**
         * @param {?} formModel
         * @param {?=} options
            ...
            function (model) {
                ...
                switch (model.type) {
                    ...
                    default:
                        ...
                        controls[model.id] = new forms.FormControl(controlState, controlOptions);
                }
            }));
            return new forms.FormGroup(controls, options);
        };
        /**
         * @param {?} model
         * @return {?}
        ...
        /** @nocollapse */ DynamicFormService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function DynamicFormService_Factory() { return new DynamicFormService(core.ɵɵinject(DynamicFormValidationService)); }, token: DynamicFormService, providedIn: "root" });
     ...
     */
    /** @type {?} */
    var DYNAMIC_FORM_CONTROL_MAP_FN = new core.InjectionToken("DYNAMIC_FORM_CONTROL_MAP_FN");
    var DynamicFormComponentService = /** @class */ (function () {
        ...
        DynamicFormComponentService.ctorParameters = function () { return [
            { type: undefined, decorators: [{ type: core.Inject, args: [DYNAMIC_FORM_CONTROL_MAP_FN,] }, { type: core.Optional }] }
        ]; };
        /** @nocollapse */ DynamicFormComponentService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function DynamicFormComponentService_Factory() { return new DynamicFormComponentService(core.ɵɵinject(DYNAMIC_FORM_CONTROL_MAP_FN, 8)); }, token: DynamicFormComponentService, providedIn: "root" });
    ...
    var DynamicFormLayoutService = /** @class */ (function () {
        ...
        function (model, templates) {
            ...
            if (templates instanceof core.QueryList) {
        ...
        */
        ...
        /** @nocollapse */ DynamicFormLayoutService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function DynamicFormLayoutService_Factory() { return new DynamicFormLayoutService(); }, token: DynamicFormLayoutService, providedIn: "root" });
    ...
    var OR_OPERATOR = "OR";
    /** @type {?} */
    var DYNAMIC_MATCHERS = new core.InjectionToken("DYNAMIC_MATCHERS");
    /** @type {?} */
    var DisabledMatcher = {
    ...
    var DynamicFormRelationService = /** @class */ (function () {
        ...
        function (model, group) {
            ...
            function (controls, condition) {
                ...
                if (!controls.hasOwnProperty(path)) {
                    ...
                    control instanceof forms.FormControl ? controls[path] = control : console.warn("No related form control with id " + condition.id + " could be found");
                }
                return controls;
            });
            /** @type {?} */
        ...
        function (model, group, control) {
            ...
            function (relatedControl) {
                /** @type {?} */
                var valueChanges = relatedControl.valueChanges.pipe(operators.startWith(relatedControl.value));
                /** @type {?} */
                var statusChanges = relatedControl.statusChanges.pipe(operators.startWith(relatedControl.status));
                subscriptions.push(rxjs.merge(valueChanges, statusChanges).subscribe((/**
                 * @return {?}
                 */
                function () {
        ...
        DynamicFormRelationService.ctorParameters = function () { return [
            { type: Array, decorators: [{ type: core.Optional }, { type: core.Inject, args: [DYNAMIC_MATCHERS,] }] },
            { type: core.Injector }
        ]; };
        /** @nocollapse */ DynamicFormRelationService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function DynamicFormRelationService_Factory() { return new DynamicFormRelationService(core.ɵɵinject(DYNAMIC_MATCHERS, 8), core.ɵɵinject(core.INJECTOR)); }, token: DynamicFormRelationService, providedIn: "root" });
    ...
    exports.DISABLED_MATCHER = DISABLED_MATCHER;
    ...
    exports.DYNAMIC_MATCHERS = DYNAMIC_MATCHERS;
    exports.DYNAMIC_MATCHER_PROVIDERS = DYNAMIC_MATCHER_PROVIDERS;
    ...
    exports.DisabledMatcher = DisabledMatcher;
    ...
    exports.DynamicFormComponentService = DynamicFormComponentService;
    ...
    exports.HIDDEN_MATCHER = HIDDEN_MATCHER;
    exports.HiddenMatcher = HiddenMatcher;
    exports.MATCH_DISABLED = MATCH_DISABLED;
    exports.MATCH_ENABLED = MATCH_ENABLED;
    exports.MATCH_HIDDEN = MATCH_HIDDEN;
    exports.MATCH_OPTIONAL = MATCH_OPTIONAL;
    exports.MATCH_REQUIRED = MATCH_REQUIRED;
    exports.MATCH_VISIBLE = MATCH_VISIBLE;
    exports.METADATA_KEY_SERIALIZABLE = METADATA_KEY_SERIALIZABLE;
    exports.OR_OPERATOR = OR_OPERATOR;
    exports.REQUIRED_MATCHER = REQUIRED_MATCHER;
    exports.RequiredMatcher = RequiredMatcher;
